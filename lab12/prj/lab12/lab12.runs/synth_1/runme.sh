...
HD_PWD='Y:/Code/github/Digital_System_Experiment/lab12/prj/lab12/lab12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_7seg_pro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_7seg_pro.tcl
