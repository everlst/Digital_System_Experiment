...
HD_PWD='Y:/Code/github/Digital_System_Experiment/lab12/prj/lab12/lab12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_7seg_pro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_7seg_pro.tcl -notrace
